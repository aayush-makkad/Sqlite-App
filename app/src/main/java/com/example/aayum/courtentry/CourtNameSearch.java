...
public class CourtNameSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_court_name_search);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Cursor res = mdb.getCaseDiaCourtData(_client.getText().toString());
                if (res.getCount() == 0) {
                    // show message
