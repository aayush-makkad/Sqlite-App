...
public class clientNameSearch extends AppCompatActivity {

    DatabaseHelper mdb = new DatabaseHelper(this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_client_name_search);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Cursor res = mdb.getCaseDiaData(_client.getText().toString());
                if (res.getCount() == 0) {
                    // show message
